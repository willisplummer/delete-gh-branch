...
},{"callbag-for-each":7,"callbag-from-obs":4,"callbag-from-iter":5,"callbag-from-event":6,"callbag-from-promise":8,"callbag-interval":10,"callbag-map":9,"callbag-scan":11,"callbag-flatten":13,"callbag-take":12,"callbag-skip":16,"callbag-filter":14,"callbag-merge":15,"callbag-concat":17,"callbag-combine":20,"callbag-share":18,"callbag-pipe":19}],1:[function(require,module,exports) {
"use strict";var e=require("callbag-basics"),t=function e(){var t=document.querySelector(".post-merge-message button");t?t.innerHTML.includes("Delete branch")&&t.click():setTimeout(e,200)};(0,e.pipe)((0,e.fromEvent)(document,"click"),(0,e.filter)(function(e){return e.target.className&&"string"==typeof e.target.className&&e.target.className.includes("js-merge-commit-button")}),(0,e.forEach)(function(e){return setTimeout(t,200)}));
