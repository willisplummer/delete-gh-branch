...
},{"callbag-for-each":4,"callbag-from-obs":5,"callbag-from-iter":6,"callbag-from-event":7,"callbag-from-promise":8,"callbag-interval":9,"callbag-map":10,"callbag-scan":11,"callbag-flatten":12,"callbag-take":13,"callbag-skip":14,"callbag-filter":15,"callbag-merge":16,"callbag-concat":17,"callbag-combine":19,"callbag-share":18,"callbag-pipe":20}],1:[function(require,module,exports) {
"use strict";var e=require("callbag-basics");(0,e.pipe)((0,e.fromEvent)(document,"click"),(0,e.filter)(function(e){return"BtnGroup btn-group-merge"===e.target.parentNode.className}),(0,e.forEach)(function(e){return console.log(e.target.className,e.target.parentNode.className)}));
